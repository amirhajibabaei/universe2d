...
!
   ...
   integer             :: g(2), shift(2), idx, n,  cycle_reward, &
                          step, steps, cyc, all_cycles, uscalars, uvectors, &
                          tdamp, dump_every, cyc_dump, dump_total, ntry, nsuccess
   real(pr)            :: energy, virial, step_time, psi(2), &
                          rho, tem, rc, rc2, ecut, dmax, rnd, alpha, eargs(3)
   ...
   do cyc = 1, all_cycles
      ...
      call pos%metro(efunc2,eargs,tem,dmax,steps,step)
      nsuccess = nsuccess + step
